...
export default function Home() {
  ...
  const { account: connectedAccount, loading, error, connect: connectWallet, disconnect: disconnectWallet } = useWallet()
    ...
    <div className="min-h-screen bg-black text-gray-300 font-sans antialiased">
      ...
      {connectedAccount ? (
        ...
        <section className="py-12 px-6 text-center">
          <p className="text-gray-400">Connect your wallet to view personalized yields, strategies, and platform details.</p>
        </section>
      )}
